...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1E3A8A] to-[#3B82F6] text-gray-100">
      <header className="px-6 py-10 text-center">
        <h1 className="text-3xl font-semibold text-white">Contact PD Heating & Plumbing</h1>
      ...
      <main className="max-w-4xl mx-auto px-6 pb-16">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-4 py-2 rounded-md bg-white text-[#1E3A8A] hover:bg-gray-100 transition"
          >
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input
                    ...
                    required
                    className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#1E3A8A]"
                  />
                  <input
                    type="email"
                    value={email}
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="inline-flex items-center px-5 py-2.5 rounded-md bg-[#1E3A8A] hover:bg-[#1e40af] text-white transition disabled:opacity-60"
                  >
